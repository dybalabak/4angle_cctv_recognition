...
###### Parameters setting
dim = (224,224) # MobileNetV2 or any other used
n_sequence = 8
n_channels = 3 # RGB Channel
n_output = 13 # number of output class
weights_path = 'save_weight/weight-data-20201124-720-0.91-0.87.hdf5' # pretrain weight path
#######
...
while(cap.isOpened()):
    ...
    if ret == True:
        ...
        print(time.time()-start, "taken for resizing")
        start = time.time()
        new_f = new_f/255.0
